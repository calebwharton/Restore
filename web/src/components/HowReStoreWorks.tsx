    ...
    return (
        <div className="bg-primary p-6 rounded-lg shadow-lg">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6">
                <div className="flex flex-col items-center p-4 bg-secondary rounded-3xl">
                    ...
                    <img src={Selling} alt={"fe"} className="w-20 h-20 mb-4" />
                </div>
                <div className="flex flex-col items-center p-4 bg-secondary rounded-3xl">
                    <p className="text-white bg-accent py-1 px-6 rounded-lg">
                        STEP 2
                    ...
                    <img src={Trust} alt={"fe"} className="w-20 h-20 mb-4" />
                </div>
                <div className="flex flex-col items-center p-4 bg-secondary rounded-3xl">
                    <p className="text-white bg-accent py-1 px-6 rounded-lg">
                        STEP 3
                    ...
                    <img src={Buying} alt={"fe"} className="w-20 h-20 mb-4" />
                </div>
            </div>
        </div>
    );
